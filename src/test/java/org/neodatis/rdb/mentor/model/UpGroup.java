...
public class UpGroup extends org.neodatis.rdb.DbObjectWithLongId  implements DbObjectMapping , org.neodatis.rdb.ToX
 ,java.io.Serializable
{
	//** Database fields
	protected Long dbid;
	protected Long dbid_company;
	protected String dbname;
	protected Long dbstatus;
	protected Long dbdeleted;
	//** Db Object
	public static Service<UpGroup> DB = new Service<UpGroup>(UpGroup.class);
	...
	{
		return new DefaultDBTable("up_group");
	}
	...
	// Setter for attribute idCompany
	public void setIdCompany( Long in_idCompany ) 
	{
		dbid_company = in_idCompany;
	}

	// Getter for attribute idCompany
	...
	public String toString()
	{
		...
		sResult.append( "\t idCompany : " ).append( getIdCompany()).append("\n");
	...
	public java.util.Map<String,Object> toMap()
	{
		...
		map.put( "idCompany" , String.valueOf(getIdCompany()));
	...
	public String toJSon()
	{
		...
		sResult.append( ",");
		sResult.append( "\"idCompany\":\"" ).append(String.valueOf(getIdCompany()) ).append("\"");
		sResult.append( ",");
	...
	public java.util.List<String> toList()
	{
		...
		list.add( String.valueOf(getIdCompany()));
