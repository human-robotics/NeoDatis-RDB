...
public class Up extends org.neodatis.rdb.DbObjectWithLongId  implements DbObjectMapping , org.neodatis.rdb.ToX
 ,java.io.Serializable
{
	//** Database fields
	protected Long dbid;
	protected Long dbid_up_group;
	protected String dbname;
	protected Long dbstatus;
	protected Long dbdeleted;
	//** Db Object
	public static Service<Up> DB = new Service<Up>(Up.class);
	...
	// Setter for attribute idUpGroup
	public void setIdUpGroup( Long in_idUpGroup ) 
	{
		dbid_up_group = in_idUpGroup;
	}

	// Getter for attribute idUpGroup
	public Long getIdUpGroup()
	{
		return dbid_up_group;
	}
	...
	public String toString()
	{
		...
		sResult.append( "\t idUpGroup : " ).append( getIdUpGroup()).append("\n");
	...
	public java.util.Map<String,Object> toMap()
	{
		...
		map.put( "idUpGroup" , String.valueOf(getIdUpGroup()));
	...
	public String toJSon()
	{
		...
		sResult.append( ",");
		sResult.append( "\"idUpGroup\":\"" ).append(String.valueOf(getIdUpGroup()) ).append("\"");
		sResult.append( ",");
	...
	public java.util.List<String> toList()
	{
		...
		list.add( String.valueOf(getIdUpGroup()));
