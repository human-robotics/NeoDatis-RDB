...
public class UpDBHelper{
	public static final DBTable table = new DefaultDBTable("up");

	public static final DBColumn ID =  new DefaultDBColumn( table , "id" , Long.class );
	public static final DBColumn ID_UP_GROUP =  new DefaultDBColumn( table , "id_up_group" , Long.class );
