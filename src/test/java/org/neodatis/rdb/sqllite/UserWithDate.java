...
public class UserWithDate extends org.neodatis.rdb.DbObjectWithLongId  implements DbObjectMapping , org.neodatis.rdb.ToX
{
	//** Database fields
	protected Long dbid;
	...
	//** Db Object
	public static Service<UserWithDate> DB = new Service<UserWithDate>(UserWithDate.class);
	...
	{
		return new DefaultDBTable("User_With_Date");
	}
