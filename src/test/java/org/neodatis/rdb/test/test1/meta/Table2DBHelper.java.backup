...
public class Table2DBHelper{
	public static final DBTable table = new DefaultDBTable("table2");
	...
	public static final DBColumn DATA =  new DefaultDBColumn( table , "DATA" , byte[].class );

	//** To get the column list
	static public DBColumn [] getColumns()
	{
		DBColumn [] array = new DefaultDBColumn[3];
		array[0] = ID;
		array[1] = NAME;
		array[2] = DATA;
		return array;
